...
import 'mechanic_details_screen.dart';

class MechanicsTab extends StatefulWidget {
  const MechanicsTab({Key? key}) : super(key: key);

  @override
  State<MechanicsTab> createState() => _MechanicsTabState();
}

class _MechanicsTabState extends State<MechanicsTab> {
  ...
  Future<void> _searchMechanics() async {
    ...
    try {
      ...
      final uri = Uri.parse(
        'https://smiling-sparrow-proper.ngrok-free.app/api/admin/mechanics/search',
          ...
          if (_isSearchVisible)
            Container(
              ...
              child: TextField(
                ...
                onSubmitted: (value) => _searchMechanics(),
              ),
            ),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${_mechanics.length} mechanics found',
                          style: const TextStyle(
                            fontFamily: 'UberMoveText',
                            fontSize: 12,
                            color: Color(0xFF64748B),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildDetailItem(
                                ...
                                'Registration Date',
                                _formatDate(mechanic['registrationDate']),
                              ),
                              const SizedBox(height: 16),
                              Align(
