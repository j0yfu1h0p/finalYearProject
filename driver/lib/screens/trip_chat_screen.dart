...
import 'package:driver/services/trip_chat_service.dart';
import 'package:intl/intl.dart';

class TripChatScreen extends StatefulWidget {
  final String tripId;
  final String tripModel; // 'ServiceRequest' or 'MechanicServiceRequest'
...
class _TripChatScreenState extends State<TripChatScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    // Determine the current user's role in this chat context
    final String currentUserModel = widget.tripModel == 'MechanicServiceRequest' ? 'Mechanic' : 'Driver';
            ...
            child: _messages.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final senderModel = m['senderModel']?.toString() ?? '';
                      final isMe = senderModel == currentUserModel;
                      final text = (m['message'] ?? '').toString();
                      final timestamp = m['timestamp'] ?? m['createdAt'];

                      // Safely get sender name - improved for mechanic context
                      String senderName;
                      try {
                        if (isMe) {
                          senderName = 'You';
                          ...
                          if (sender is Map) {
                            ...
                            // If sender is a string (ID), show generic name
                            senderName = 'Customer';
                          }
                        }
                      } catch (e) {
                        senderName = isMe ? 'You' : 'Customer';
                      }

                      // Use a different color for mechanics
                      final myColor = currentUserModel == 'Mechanic' ? Colors.purple[500] : Colors.green[500];
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isMe ? myColor : Colors.grey[200],
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: widget.tripModel == 'MechanicServiceRequest'
                        ? Colors.purple[500]
                        : Colors.green[500],
                      shape: BoxShape.circle,
                    ),
