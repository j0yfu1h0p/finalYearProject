...
/// A reusable refresh button widget with cooldown functionality
/// Prevents rapid API calls by enforcing a 10-second cooldown between refreshes
...
class _RefreshButtonWidgetState extends State<RefreshButtonWidget> {
  ...
  void _handleRefresh() {
    if (_isOnCooldown) {
      // Show message that cooldown is active
